...
I see this whole `List of technologies` thing on every github profile so I guess I should put one too yes because LIST == COOL!!!! 💯\
...
That whole list shouldnt mean anything to you, it's a visual component\
For actual stacks & libs that I use and learn from:\
...
NOT a complete list of anything! It depends from project to project - These 2 stacks above are from my 2 recent projects, Quizzle and ---
